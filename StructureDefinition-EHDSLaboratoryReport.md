# Laboratory report model - EHDS Logical Information Models v0.2.1
...
| | |
| :--- | :--- |
| *Official URL*:http://www.xt-ehr.eu/fhir/models/StructureDefinition/EHDSLaboratoryReport | *Version*:0.2.1 |
| Draft as of 2025-11-18 | *Computable Name*:EHDSLaboratoryReport |
...
```json
{
  ...
  "status" : "draft",
  "date" : "2025-11-18T11:31:47+00:00",
  "publisher" : "Xt-EHR",
  "contact" : [
    {
      "name" : "Xt-EHR",
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "EHDSLaboratoryReport.header.authorship",
        "path" : "EHDSLaboratoryReport.header.authorship",
        "short" : "Authorship of the laboratory report"
      },
      {
        "id" : "EHDSLaboratoryReport.header.authorship.author[x]",
        "path" : "EHDSLaboratoryReport.header.authorship.author[x]",
