...
* body 0..1 Base "Structured body of the discharge report document" 
  ...
  * alerts 0..1 Base "Section: Alerts." "Information about substantial alerts or warnings that health professionals should be aware of."
    ...
    * medicalAlert 0..* CodeableConcept "A warning, other than included in allergies." "The warning can be entered in code (there are codes for frequently used alerts) but seeing the dynamic nature of the warnings, these alerts will often be entered as free text"
