...
// Elements inherited from EHDSObservationCore:
// - observationDate[x]
// - code
// - resultDescription
// - result (value[x])
...
// - referenceRange
// - interpretation
// - component (code, result, referenceRange, interpretation)
...
// Extended result with uncertainty
* result.uncertainty 0..1 Base "Measurement uncertainty type and interval if needed."
...
// Extended component with dataAbsentReason
* component.dataAbsentReason 0..1 CodeableConcept "Provides a reason why the expected value in the element Observation.value[x] is missing."
  * ^binding.description = "HL7 Data absent reason"
  * ^binding.strength = #preferred
