...
* countryOfAffiliation 0..1 CodeableConcept "The patient's country of affiliation"
  * ^binding.description = "ISO 3166"
  * ^binding.strength = #preferred
// eHN: same, but should be current country of affiliation
