Logical: EHDSAllergyIntoleranceCore
Parent: EHDSDataSet
...
* reaction.severity 0..1 CodeableConcept "Severity of the clinical manifestation of the allergic reaction."
  * ^binding.description = """
...
Parent: EHDSAllergyIntoleranceCore
Title: "Allergy intolerance model"
Description: """EHDS refined base model for allergy/intolerance"""
Characteristics: #can-be-target

// Elements inherited from EHDSAllergyIntoleranceCore:
// - description
// - agentOrAllergen
// - reaction (base structure)

// Extended reaction with additional fields
* reaction.date 0..1 dateTime "Date and time of allergy manifestation"

* reaction.onsetDate 0..1 dateTime "Date of the observation of the reaction"
