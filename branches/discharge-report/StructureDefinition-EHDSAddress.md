# Address model - EHDS Logical Information Models v0.2.1
...
| Draft as of 2025-12-03 | *Computable Name*:EHDSAddress |
...
* Use this Logical Model: [Health professional model](StructureDefinition-EHDSHealthProfessional.md), [Location model](StructureDefinition-EHDSLocation.md), [Organisation model](StructureDefinition-EHDSOrganisation.md), [Patient Animal model](StructureDefinition-EHDSPatientAnimal.md)...Show 2 more,[Patient model](StructureDefinition-EHDSPatientCore.md)and[Related person model](StructureDefinition-EHDSRelatedPerson.md)
