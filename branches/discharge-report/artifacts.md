...
| [Allergy intolerance model](StructureDefinition-EHDSAllergyIntoleranceCore.md) | EHDS refined base model for allergy/intolerance |
...
| [Condition model](StructureDefinition-EHDSConditionCore.md) | EHDS refined base model for a clinical condition, problem, diagnosis, or other event, situation, issue, or clinical concept that has risen to a level of concern. |
...
| [Device use model](StructureDefinition-EHDSDeviceUseCore.md) | EHDS refined base model for device use information |
| [Discharge Report model](StructureDefinition-EHDSDischargeReportCore.md) | EHDS refined base model for Discharge Report |
...
| [Dosaging model](StructureDefinition-EHDSDosagingCore.md) | Logical model for usage instructions for administring the requested product. Based on FHIR Dosage complex data type. When implemented, this model may be reduced significantly according to the specific use case. |
| [Encounter model](StructureDefinition-EHDSEncounter.md) | EHDS refined base model for Encounter |
| [Encounter model](StructureDefinition-EHDSEncounterCore.md) | EHDS refined base model for Encounter |
...
| [Functional status](StructureDefinition-EHDSFunctionalStatusCore.md) | EHDS refined base model for Functional status |
...
| [Human name model](StructureDefinition-EHDSHumanNameCore.md) | EHDS refined base model for Human name |
...
| [Medication model](StructureDefinition-EHDSMedicationCore.md) | Logical model for prescribed/dispensed medication. The model is shared by statements, requests, dispensations, and treatment lines. Each of those may have different restrictions in FHIR profile. Model is suitable for generic/virtual medications as well as branded/real products. |
...
| [Medication statement model](StructureDefinition-EHDSMedicationStatementCore.md) | Statement about a single medication as part of a medication summary. |
| [Observation model](StructureDefinition-EHDSObservation.md) | EHDS refined base model for Observation information |
| [Observation model](StructureDefinition-EHDSObservationCore.md) | EHDS refined base model for Observation information |
...
| [Patient model](StructureDefinition-EHDSPatientCore.md) | EHDS refined base model for patient (subject of care) information |
...
| [Procedure model](StructureDefinition-EHDSProcedureCore.md) | EHDS refined base model for an action that is or was performed on or for a patient |
...
| [Specimen model](StructureDefinition-EHDSSpecimenCore.md) | EHDS refined base model for A sample to be used for Analysis |
