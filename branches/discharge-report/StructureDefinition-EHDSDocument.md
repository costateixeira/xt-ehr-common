...
| Draft as of 2025-12-03 | *Computable Name*:EHDSDocument |
...
* Derived from this Logical Model: [Discharge Report model](StructureDefinition-EHDSDischargeReportCore.md), [Imaging report model](StructureDefinition-EHDSImagingReport.md), [Laboratory report model](StructureDefinition-EHDSLaboratoryReport.md) and [Patient summary model](StructureDefinition-EHDSPatientSummary.md)
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "short" : "The person or organization taking responsibility for the medical content of the document",
