...
| Draft as of 2025-12-03 | *Computable Name*:EHDSAdvanceDirective |
...
* Use this Logical Model: [Discharge Report model](StructureDefinition-EHDSDischargeReportCore.md) and [Patient summary model](StructureDefinition-EHDSPatientSummary.md)
