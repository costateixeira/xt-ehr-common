...
| Draft as of 2025-12-03 | *Computable Name*:EHDSRelatedPerson |
...
* Use this Logical Model: [Advance directive model](StructureDefinition-EHDSAdvanceDirective.md), [Device use model](StructureDefinition-EHDSDeviceUse.md), [Discharge Report model](StructureDefinition-EHDSDischargeReportCore.md), [Imaging report model](StructureDefinition-EHDSImagingReport.md)...Show 3 more,[Laboratory report model](StructureDefinition-EHDSLaboratoryReport.md),[Medication dispense model](StructureDefinition-EHDSMedicationDispense.md)and[Observation model](StructureDefinition-EHDSObservationCore.md)
